...
class LSTMAttenLSTMTrainer(ModelTrainer):
    def __init__(
            self,
            model,
    ...
    def train(self,
              ...
              save_best: bool = True,
              savename: Optional[str] = 'best_lstm_atten_lstm') -> Dict[str, List[float]]:
        ...
        self.logger.info(
            f'Beginning LSTMAttenLSTM Training on {epochs} epochs with initial lr {self.lr}.')
        ...
        save_dir = "modelsave/lstm_atten_lstm"
